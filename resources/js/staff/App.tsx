...
import { SmsGroupsPage } from './pages/SmsGroupsPage';
                ...
                <ProtectedRoute>
                  <AppShell>
                    <Routes>
                      ...
                      <Route path="/sms/groups" element={<ProtectedRoute allowedRoles={['admin']}><SmsGroupsPage /></ProtectedRoute>} />
                      ...
                      <Route path="/reports" element={<ProtectedRoute allowedRoles={['admin', 'stock_manager', 'accountant']}><ReportsPage /></ProtectedRoute>} />
                      <Route path="/users" element={<ProtectedRoute allowedRoles={['admin']}><UsersPage /></ProtectedRoute>} />
                      <Route path="/warehouse" element={<ProtectedRoute allowedRoles={['admin', 'stock_manager', 'accountant']}><WarehousePage /></ProtectedRoute>} />
                      <Route path="/delivery-zones" element={<ProtectedRoute allowedRoles={['admin', 'sales']}><DeliveryZonesPage /></ProtectedRoute>} />
                      <Route path="/expenses" element={<ProtectedRoute allowedRoles={['admin', 'sales', 'accountant']}><ExpensesPage /></ProtectedRoute>} />
