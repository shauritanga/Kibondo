...
<head>
  ...
  <title>Thank you for your order {{ $sale->sale_number }}</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <p>Thank you for your order <strong>{{ $sale->sale_number }}</strong>. We have received it and it is now being processed.</p>
      <div class="badge">✓ Order Received</div>
      <p>We will confirm your delivery date and tracking details shortly.</p>
