...
<head>
  ...
  <title>Payment received for {{ $sale->sale_number }}</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <p>We have received your payment for order <strong>{{ $sale->sale_number }}</strong>.</p>
      ...
      <div class="detail-box">
        ...
        <div class="detail-row"><span class="label">Order amount</span><span class="value">TZS {{ number_format($order_price) }}</span></div>
        <div class="detail-row"><span class="label">Outstanding</span><span class="value">TZS {{ number_format($outstanding) }}</span></div>
      </div>
      <p>Thank you for your payment. Delivery charges, if any, are handled separately and are not included above.</p>
    </div>
