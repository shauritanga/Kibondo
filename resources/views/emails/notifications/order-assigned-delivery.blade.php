...
<head>
  ...
  <title>New delivery assignment: {{ $sale->sale_number }}</title>
  <style>
...
<body>
  <div class="wrapper">
    <div class="header">
      ...
      <div class="header-tagline">Delivery Assignment</div>
    </div>
    ...
    <div class="body">
      ...
      <p>Log in to the dashboard to mark this order as delivered once complete.</p>
    </div>
